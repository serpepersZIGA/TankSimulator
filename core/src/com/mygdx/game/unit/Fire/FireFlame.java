...
public class FireFlame extends Fire {
    public void FireIteration(Unit unit){
        ...
        Main.BulletList.add(new BullFlame(unit.fire_x,unit.fire_y,-unit.rotation_tower+ -10+rand.rand(20),unit.damage,unit.t_damage,unit.penetration,unit.team,unit.height));
        Main.BulletList.add(new BullFlame(unit.fire_x,unit.fire_y,-unit.rotation_tower+ -10+rand.rand(20),unit.damage,unit.t_damage,unit.penetration,unit.team,unit.height));
