...
public class FireAcid extends Fire{
    public void FireIteration(Unit unit){
        ...
        unit.fire_x = (float) (unit.tower_x+unit.tower_width_2+((unit.tower_height_2+unit.y_tower) *sin(-unit.rotation_tower*3.1415926535/180)));
        unit.fire_y = (float) (unit.tower_y+unit.tower_height_2+((unit.tower_height_2+unit.y_tower) *cos(-unit.rotation_tower*3.1415926535/180)));
        Main.BulletList.add(new BullAcid(unit.fire_x,unit.fire_y, -unit.rotation_tower+ -10+rand.rand(20),  unit.damage, unit.penetration,unit.team,unit.height));
        Main.BulletList.add(new BullAcid(unit.fire_x,unit.fire_y, -unit.rotation_tower+ -10+rand.rand(20),  unit.damage, unit.penetration,unit.team,unit.height));
