...
public class TransportRegister {
    ...
    public TransportRegister() {
        ...
        PanzerMortarT1 = new PanzerMortarT1(0,0, Main.UnitList,true,(byte)2);
        PanzerFlameT1 = new PanzerFlameT1(0,0, Main.UnitList,true,(byte)2);
        PanzerAcidT1 = new PanzerAcidT1(0,0, Main.UnitList,true,(byte)2);
        PanzerT1 = new PanzerT1(0,0, Main.UnitList,true,(byte)2);
