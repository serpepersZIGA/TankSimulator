...
public class PlayerCannonMortar extends Unit {
    public PlayerCannonMortar(float x, float y,boolean host, byte team){
        ...
        this.tower_obj.add(new TowerBullTankPlayer(18,55,52,-12,5,2,20,12, this.id_unit,
                (byte)1,this.team,Main.ContentImage.tower_player_auxiliary_1,Main.ContentSound.machinegun));
        this.tower_obj.add(new TowerBullTankPlayer(18,55,52,12,5,2,20,12, this.id_unit,
                (byte)1,this.team,Main.ContentImage.tower_player_auxiliary_1,Main.ContentSound.machinegun));
        this.difference = 18;
        const_tower_x = 34;
