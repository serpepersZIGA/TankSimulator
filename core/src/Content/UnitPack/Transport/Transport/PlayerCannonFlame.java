...
import Content.UnitPack.Transport.Tower.TowerMortarPlayer;
...
public class PlayerCannonFlame extends Unit {
    public PlayerCannonFlame(float x, float y, boolean host, byte team){
...
//        this.y_tower = 20;
        ...
        this.tower_obj.add(new TowerMortarPlayer(18,55,52,-12,40,2,
                ...
                (byte)1,(byte)1,Main.ContentImage.tower_player_auxiliary_1, Main.ContentSound.cannon));
        this.tower_obj.add(new TowerMortarPlayer(18,55,52,12,40,2,
                65,12,15,15, this.id_unit,
                (byte)1,(byte)1,Main.ContentImage.tower_player_auxiliary_1, Main.ContentSound.cannon));
